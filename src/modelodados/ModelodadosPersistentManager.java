...
public class ModelodadosPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Modelodados";
	...
	private ModelodadosPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ModelodadosPersistentManager();
		}
